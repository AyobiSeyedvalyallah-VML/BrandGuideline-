...
def config(html_content):
    ...
    response = openai.chat.completions.create(
        model=MODEL,
        messages=[
            {"role": "system", "content":  """you will receive an html and try to extract information from it, ONLY the information exist in the html. If yuo cannot find the information for the related field in the configuration, leave the field empty. return the output ONLY in the following format:
